  ...
  return (
    <View className="bg-surface border border-lineSubtle rounded-2xl mb-3 overflow-hidden">
      ...
      <View className="flex-row px-4 py-3 gap-2 flex-wrap">
          ...
          return (
            <Pressable
              ...
              style={{
                ...
                backgroundColor: on ? col + '18' : '#222222',
                borderWidth: 1, borderColor: on ? col + '40' : '#333333',
        ...
        {saving && <ActivityIndicator size="small" color="#AAFF00" style={{ marginLeft: 4 }} />}
      </View>
    </View>
  );
}
...
function MatrixCell({ has }: { has: boolean }) {
  return (
    <View style={{
      ...
      backgroundColor: has ? 'rgba(170,255,0,0.15)' : '#1A1A1A',
      borderWidth: 1, borderColor: has ? 'rgba(170,255,0,0.30)' : '#222',
    }}>
      {has && <Feather name="check" size={11} color="#AAFF00" />}
    </View>
  );
}
              ...
              return (
                <Pressable
                  ...
                  style={{
                    ...
                    borderWidth: 1, borderColor: active ? '#AAFF00' : '#333333',
                  }}
                >
          ...
          <View className="flex-row items-center justify-between mb-4">
            ...
            <View className="flex-row gap-2">
              ...
              <View
                ...
                style={{ backgroundColor: 'rgba(170,255,0,0.10)', borderColor: 'rgba(170,255,0,0.25)' }}
              >
                ...
                {unconfiguredKeys.map(key => (
                  ...
                  >
                    {savingModule === key
                      ...
                      : <Feather name="plus" size={12} color="#AAFF00" />
                    }
                  ...
                  >
                    ...
                    {DEFAULT_ROLES.map(r => (
                      <View key={r.id} style={{ width: isWide ? 90 : 72, alignItems: 'center' }}>
                        <Text style={{ color: '#AAFF00', fontSize: 11, fontWeight: '700', textTransform: 'capitalize' }}>
                          {r.name}
                        </Text>
                        <Text style={{ color: '#555', fontSize: 9, marginTop: 2 }}>V·C·E·D·X</Text>
                      </View>
                    ))}
                  </View>
                  ...
                  {Object.entries(matrix.matrix).map(([mod, roleEntries], idx) => (
                    ...
                    >
                      ...
                      <View style={{ width: isWide ? 160 : 120, flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                        <View style={{ width: 24, height: 24, borderRadius: 7, backgroundColor: '#1A1A1A', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#222' }}>
                          <Text style={{ color: '#AAFF00', fontSize: 10, fontWeight: '900' }}>{mod[0].toUpperCase()}</Text>
                        </View>
